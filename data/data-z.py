...
# z 값 제거 함수 정의
def remove_z_values(landmarks):
    """z 값을 제거하여 x, y 좌표만 반환"""
    return landmarks[:, :2]  # x, y 좌표만 반환
